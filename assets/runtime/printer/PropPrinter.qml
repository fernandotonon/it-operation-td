...
Node {
    ...
    Texture {
        ...
        source: "maps/qtmesh_gen3d_1_1789953316265_diffuse.png"
    }
    Texture {
        ...
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: "maps/qtmesh_gen3d_1_1789953316265_roughness.png"
    }
    Texture {
        ...
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: "maps/qtmesh_gen3d_1_1789953316265_normal.png"
    }
    PrincipledMaterial {
