...
Node {
    ...
    Texture {
        ...
        source: "maps/qtmesh_gen3d_1_1789951771506_diffuse.jpg"
    }
    Texture {
        ...
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: "maps/qtmesh_gen3d_1_1789951771506_roughness.jpg"
    }
    Texture {
        ...
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: "maps/qtmesh_gen3d_1_1789951771506_normal.jpg"
    }
    PrincipledMaterial {
