...
Rectangle {
    ...
    width: compact ? 96 : 126; height: compact ? 72 : 92
    radius: 14
    ...
    // silhouette per role
    Item {
        width: 44; height: 34; anchors.horizontalCenter: parent.horizontalCenter; y: root.compact ? 2 : 8; scale: root.compact ? 0.8 : 1
    ...
    Text { text: root.name; color: "white"; font.pixelSize: root.compact ? 10 : 12; font.bold: true; anchors.horizontalCenter: parent.horizontalCenter; y: root.compact ? 36 : 46; width: parent.width - 6; horizontalAlignment: Text.AlignHCenter; elide: Text.ElideRight }
    Row { anchors.horizontalCenter: parent.horizontalCenter; y: root.compact ? 50 : 66; spacing: 4
